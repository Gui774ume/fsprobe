...
// ParseDentryResolutionMode - Parses the provided dentry resolution mode
func ParseDentryResolutionMode(input string) DentryResolutionMode {
	switch input {
	case "fragments":
		return DentryResolutionFragments
	case "single_fragment":
		return DentryResolutionSingleFragment
	default:
		return DentryResolutionPerfBuffer
	}
}
